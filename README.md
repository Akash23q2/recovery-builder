wowkowoeoemsnZnnznznznzznjdbdnsms.z.zmsmskskkkkjkeks# AOSP Builder
...
10. Now use "build" branch andbuild" and "sync" again (with your device sauce and rom manifest), this time also edit "ccache_upload" branch and place your download link and edit the extract name respectively(depending on what name you've given while mirroring)
...
12. see "example" branch to see how s
